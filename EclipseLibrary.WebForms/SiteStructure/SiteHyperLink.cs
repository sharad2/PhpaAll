...
namespace EclipseLibrary.Web.SiteStructure
{
    ...
    public class SiteHyperLink : HyperLink
    {
        ...
        /// </para>
        /// <para>To see the usage of <c>SiteHyperLink</c> placed inside <see cref="EclipseLibrary.Web.JQuery.MatrixField"/>
        /// please refer <see cref="EclipseLibrary.Web.JQuery.MatrixField.ItemTemplate"/>.
        /// </para>
        /// </example>
