...
namespace EclipseLibrary.Web.JQuery.Input
{
    ...
    public abstract class InputControlBase : WidgetBase, IFilterInput, IPostBackDataHandler, IFocusable, IValidator
    {
        ...
        /// </para>
        /// <para>
        /// To manually update the value of the cookie, you need to call a control specific function. For <see cref="DropDownListEx"/>,
        /// the client function to call is <c>$('#ddl').dropdownListEx('setCookie')</c>. Check the documentation of each control to determine
