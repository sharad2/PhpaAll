...
namespace PhpaAll.MvcHelpers
{
    ...
    /// </code>
    /// <para>
    /// The following attributes can be specified on each property of the model
    /// 
    ...
    public class ExcelResult : ActionResult
    {
        ...
        {
            const int ROW_NUMBER_COL_HEADING = 1;

            using (var pkg = new ExcelPackage())
            {
                pkg.Workbook.Properties.Author = context.HttpContext.User.Identity.Name ?? "Anonymous";
                pkg.Workbook.Properties.Comments = "This file was automatically generated by PHPA";
                ...
                foreach (var sheet in _sheets)
                {
                    ...
                    else
                    {
                        ...
                        var header = wks.Cells[ROW_NUMBER_COL_HEADING, 1, ROW_NUMBER_COL_HEADING, maxColIndex + 1];
