<%@ Page Title="Bank Book Doc" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="BankBook.doc.aspx.cs" Inherits="Finance.Doc.BankBook" %>

<asp:Content ID="Content6" ContentPlaceHolderID="cphNoForm" runat="server">
<br />
<p>Displays all the vouchers associated with a particular bank account. You specify
    the date range and the bank account.</p>
    <ol>
        ...
        <li>By default, the date range is set to the starting and ending of the previous calendar
            ...
            to be in the previous month's bank statement. If you are interested in seeing the
