...
namespace Eclipse.PhpaLibrary.Database.Payroll
{
    ...
    partial void OnFractionOfGrossChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FractionOfGross", UpdateCheck=UpdateCheck.Never)]
		public System.Nullable<double> FractionOfGross
		{
			get
			{
				return this._FractionOfGross;
			}
			set
			{
				if ((this._FractionOfGross != value))
				{
					this.OnFractionOfGrossChanging(value);
					this.SendPropertyChanging();
					this._FractionOfGross = value;
    ...
    partial void OnIsFractionGrossOverriddenChanged();
		...
		public bool IsFractionGrossOverridden
		{
			get
			{
				return this._IsFractionGrossOverridden;
			}
			set
			{
				if ((this._IsFractionGrossOverridden != value))
				{
					this.OnIsFractionGrossOverriddenChanging(value);
					this.SendPropertyChanging();
					this._IsFractionGrossOverridden = value;
