...
namespace Eclipse.PhpaLibrary.Reporting
{
    ...
    partial void InsertRoBill(RoBill instance);
    partial void UpdateRoBill(RoBill instance);
    partial void DeleteRoBill(RoBill instance);
    #endregion
		
		public ReportingDataContext() : 
				base(global::Eclipse.PhpaLibrary.Properties.Settings.Default.PHPADEVConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<RoBill> RoBills
		{
			get
			{
				return this.GetTable<RoBill>();
			}
		}
	}
	...
	public partial class RoVoucher : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<RoBill> _RoBill;
    ...
    partial void OnBillIdChanged();
		...
		public RoVoucher()
		{
			...
			this._RoBill = default(EntityRef<RoBill>);
			OnCreated();
		}
		...
		public System.Nullable<int> BillId
		{
			...
			set
			{
				...
				{
					if (this._RoBill.HasLoadedOrAssignedValue)
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Bill_RoVoucher", Storage="_RoBill", ThisKey="BillId", OtherKey="Id", IsForeignKey=true)]
		public RoBill RoBill
		{
			get
			{
				return this._RoBill.Entity;
			}
			set
			{
				RoBill previousValue = this._RoBill.Entity;
				if (((previousValue != value) 
							|| (this._RoBill.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._RoBill.Entity = null;
						previousValue.RoVouchers = null;
					}
					this._RoBill.Entity = value;
					if ((value != null))
					{
						value.RoVouchers = this;
					...
					this.SendPropertyChanged("RoBill");
				}
			}
		}
	...
	public partial class RoContractor : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<RoBill> _RoBills;
    ...
    partial void OnCreated();
		...
		public RoContractor()
		{
			this._RoVoucherDetails = new EntitySet<RoVoucherDetail>(new Action<RoVoucherDetail>(this.attach_RoVoucherDetails), new Action<RoVoucherDetail>(this.detach_RoVoucherDetails));
			this._RoJobs = new EntitySet<RoJob>(new Action<RoJob>(this.attach_RoJobs), new Action<RoJob>(this.detach_RoJobs));
			this._RoBills = new EntitySet<RoBill>(new Action<RoBill>(this.attach_RoBills), new Action<RoBill>(this.detach_RoBills));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="RoContractor_Bill", Storage="_RoBills", ThisKey="ContractorId", OtherKey="ContractorId")]
		public EntitySet<RoBill> RoBills
		{
			get
			{
				return this._RoBills;
			}
			set
			{
				this._RoBills.Assign(value);
			}
		}
		...
		private void attach_RoBills(RoBill entity)
		{
			this.SendPropertyChanging();
			entity.RoContractor = this;
		}
		
		private void detach_RoBills(RoBill entity)
		{
			this.SendPropertyChanging();
			entity.RoContractor = null;
		}
	...
	public partial class RoDivision : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<RoBill> _Bills;
    ...
    partial void OnCreated();
		...
		public RoDivision()
		{
			...
			this._Bills = new EntitySet<RoBill>(new Action<RoBill>(this.attach_Bills), new Action<RoBill>(this.detach_Bills));
			this._RoBills = new EntitySet<RoBill>(new Action<RoBill>(this.attach_RoBills), new Action<RoBill>(this.detach_RoBills));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="RoDivision_Bill", Storage="_Bills", ThisKey="DivisionId", OtherKey="DivisionId")]
		public EntitySet<RoBill> Bills
		{
			get
			{
				return this._Bills;
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="RoDivision_Bill1", Storage="_RoBills", ThisKey="DivisionId", OtherKey="AtDivisionId")]
		public EntitySet<RoBill> RoBills
		{
			get
			{
		...
		private void attach_Bills(RoBill entity)
		{
			this.SendPropertyChanging();
			entity.RoDivision = this;
		}
		
		private void detach_Bills(RoBill entity)
		{
			this.SendPropertyChanging();
			entity.RoDivision = null;
		}
	...
	public partial class RoBill : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<System.DateTime> _ReceiviedDate;
		...
		private System.Nullable<int> _AtDivisionId;
		
		private EntityRef<RoVoucher> _RoVouchers;
    ...
    partial void OnReceiviedDateChanging(System.Nullable<System.DateTime> value);
    partial void OnReceiviedDateChanged();
    ...
    partial void OnAtDivisionIdChanged();
		...
		public RoBill()
		{
			this._RoVouchers = default(EntityRef<RoVoucher>);
			this._RoContractor = default(EntityRef<RoContractor>);
			this._RoDivision = default(EntityRef<RoDivision>);
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ReceiviedDate", DbType="SmallDateTime", UpdateCheck=UpdateCheck.Never)]
		public System.Nullable<System.DateTime> ReceiviedDate
		{
			get
			{
				return this._ReceiviedDate;
			}
			set
			{
				if ((this._ReceiviedDate != value))
				{
					this.OnReceiviedDateChanging(value);
					this.SendPropertyChanging();
					this._ReceiviedDate = value;
					this.SendPropertyChanged("ReceiviedDate");
					this.OnReceiviedDateChanged();
				}
			}
		}
		...
		public System.Nullable<int> DivisionId
		{
			...
			set
			{
				...
				{
					if (this._RoDivision.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_StationId", DbType="Int NOT NULL", UpdateCheck=UpdateCheck.Never)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AtDivisionId", DbType="Int", UpdateCheck=UpdateCheck.Never)]
		public System.Nullable<int> AtDivisionId
		{
			get
			{
				return this._AtDivisionId;
			}
			set
			{
				if ((this._AtDivisionId != value))
				{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Bill_RoVoucher", Storage="_RoVouchers", ThisKey="Id", OtherKey="BillId", IsUnique=true, IsForeignKey=false)]
		public RoVoucher RoVouchers
		{
			get
			{
				return this._RoVouchers.Entity;
			}
			set
			{
				RoVoucher previousValue = this._RoVouchers.Entity;
				if (((previousValue != value) 
							|| (this._RoVouchers.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._RoVouchers.Entity = null;
						previousValue.RoBill = null;
					}
					this._RoVouchers.Entity = value;
					if ((value != null))
					{
						value.RoBill = this;
					}
					this.SendPropertyChanged("RoVouchers");
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="RoContractor_Bill", Storage="_RoContractor", ThisKey="ContractorId", OtherKey="ContractorId", IsForeignKey=true)]
		public RoContractor RoContractor
		{
			get
			{
			...
			set
			{
							...
							|| (this._RoContractor.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._RoContractor.Entity = null;
						previousValue.RoBills.Remove(this);
					}
					this._RoContractor.Entity = value;
					if ((value != null))
					{
						value.RoBills.Add(this);
						this._ContractorId = value.ContractorId;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="RoDivision_Bill", Storage="_RoDivision", ThisKey="DivisionId", OtherKey="DivisionId", IsForeignKey=true)]
		public RoDivision RoDivision
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="RoDivision_Bill1", Storage="_RoDivision1", ThisKey="AtDivisionId", OtherKey="DivisionId", IsForeignKey=true)]
		public RoDivision RoDivision1
		{
			...
			set
			{
							...
							|| (this._RoDivision1.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						value.RoBills.Add(this);
						this._AtDivisionId = value.DivisionId;
					}
					else
					{
						this._AtDivisionId = default(Nullable<int>);
					}
