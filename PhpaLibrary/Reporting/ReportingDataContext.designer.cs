...
namespace Eclipse.PhpaLibrary.Reporting
{
	...
	public partial class RoHeadHierarchy : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _RecoveryType = default(string);
    ...
    partial void OnStationIdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_RecoveryType", DbType="Varchar(20)", UpdateCheck=UpdateCheck.Never)]
